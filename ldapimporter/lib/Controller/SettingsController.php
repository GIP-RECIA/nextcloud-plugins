 ...
 *
 * @package OCA\LdapImporter\Controller
 *
 */
class SettingsController extends Controller
{
    ...
    /**
     * SettingsImporterController constructor.
     * @param $appName
     ...
     * @param string $cas_import_map_regex_name_uai
    ...
    public function saveSettings($cas_server_version, $cas_server_hostname, $cas_server_port, $cas_server_path, $cas_protected_groups, $cas_default_group, $cas_groups_letter_filter,
                                 ...
                                 $cas_import_map_uid, $cas_import_map_displayname, $cas_import_map_email, $cas_import_map_groups, $cas_import_regex_name_uai, $cas_import_regex_name_group, $cas_import_regex_uai_group, $cas_import_map_groups_pedagogic, $cas_import_map_groups_fonctionel, $cas_import_map_regex_name_uai, $cas_import_map_groups_description, $cas_import_map_groups_filter, $cas_import_map_groups_naming, $cas_import_map_quota, $cas_import_map_enabled, $cas_import_map_enabled_and_bitwise, $cas_import_map_dn, $cas_import_map_dn_filter,
                                 ...
                                 $cas_disable_logout = NULL, $cas_use_proxy = NULL, $cas_import_merge = NULL, $cas_import_merge_enabled = NULL, $cas_groups_letter_umlauts = NULL, $cas_keep_ticket_ids = NULL)
    {
        ...
        try {
            ...
            $this->config->setAppValue($this->appName, 'cas_import_map_groups_fonctionel', $cas_import_map_groups_fonctionel);
            $this->config->setAppValue($this->appName, 'cas_import_map_regex_name_uai', $cas_import_map_regex_name_uai);
            ...
            return array(
                'code' => 200,
                'message' => $this->l10n->t('Your Ldap Import settings have been updated.')
            );
        } catch (\Exception $e) {

            return array(
                'code' => 500,
                'message' => $this->l10n->t('Your Ldap Import settings could not be updated. Please try again.')
            );
        }
    }
}