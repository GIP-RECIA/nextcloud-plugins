OC.L10N.register(
    "richdocuments",
    {
    "No files found for this task." : "Aucun fichier trouvé pour cette tâche.",
    ...
    "Unable to determine the proper file extension for %1$s" : "Impossible de déterminer l'extension de fichier appropriée pour %1$s",
    "Unable to fetch information on %1$s" : "Impossible de récupérer les informations sur %1$s",
    "PDF (.pdf)" : "PDF (.pdf)",
    "Image (.png)" : "Image (.png)",
    "Image (.svg)" : "Image (.svg)",
    "Text (.rtf)" : "Texte (.rtf)",
    ...
    "OpenDocument Spreadsheet (.ods)" : "Feuille de calcul OpenDocument (.ods)",
    "PowerPoint Presentation (.pptx)" : "Présentation PowerPoint (.pptx)",
    "OpenDocument Presentation (.odp)" : "Présentation OpenDocument (.odp)",
    "New document" : "Nouveau document LO Write",
    "New spreadsheet" : "Nouvelle feuille de calcul LO Calc",
    "New presentation" : "Nouvelle présentation LO Impress",
    "New diagram" : "Nouveau diagramme LO Draw",
    ...
    "Presentation script" : "Scripte de présentation",
    "Write the text for your presentation here" : "Écrivez le texte de votre présentation ici",
    "Generated slide deck" : "Diaporama généré",
    "The slide deck generated" : "Le diaporama généré",
    "Nextcloud Office text document generator" : "Générateur de documents texte Nextcloud Office",
    "Document format" : "Format du document",
    "The format of the generated document" : "Le format du document généré",
    "OpenXML (docx)" : "OpenXML (docx)",
    "OpenDocument (odt)" : "OpenDocument (odt)",
    "Portable Document Format (pdf)" : "Portable Document Format (pdf)",
    "Generate Office text document" : "Générer un document texte bureautique",
    "Generate an Office text document from a prompt" : "Générer un document texte bureautique à partir d'un prompt",
    "Instructions" : "Instructions",
    "Describe the document you want the assistant to generate" : "Décrivez le document que voulez que l’assistant génère",
    "Generated Office document" : "Document Office Généré",
    "The Office document that was generated from the description" : "Ce document Office a été généré à partir de la description",
    "Nextcloud Office spreadsheet generator" : "Générateur de tableur de Nextcloud Office",
    "OpenXML (xlsx)" : "OpenXML (xlsx)",
    "OpenDocument (ods)" : "OpenDocument (ods)",
    "Generate Office spreadsheet document" : "Générer une feuille de calcul bureautique",
    "Generate an Office spreadsheet document from a prompt" : "Générer une feuille de calcul bureautique à partir d'un prompt",
    "Empty" : "Vide",
    ...
    "Accepted file types: {accepts}" : "Types de fichiers acceptés : {accepts}",
    ...
    "Custom Fonts" : "Polices de caractères personnalisées",
    "Upload font file" : "Téléverser le fichier de police de caractères",
    "Upload a font file" : "Téléverser un fichier de police",
    "Available fonts" : "Polices disponibles",
    "For ideal document compatibility we recommend you to install commonly used fonts. If your users are working with Microsoft Office, installing their proprietary fonts can be done following the documentation." : "Pour une compatibilité idéale des documents, nous vous recommandons d'installer les polices les plus courantes. Si vos utilisateurs travaillent avec Microsoft Office, l'installation de leurs polices propriétaires peut se faire en suivant la documentation.",
    "Custom fonts documentation" : "Documentation sur les polices personnalisées",
    "Secure View" : "Vue sécurisée",
    "Secure view enables you to secure office documents by blocking downloads, previews and showing a watermark" : "La vue sécurisée vous permet de sécuriser les documents bureautiques en bloquant les téléchargements, les aperçus et en affichant un filigrane",
    ...
    "Downloading the file through WebDAV will be blocked" : "Le téléchargement du fichier via WebDAV sera bloqué",
    ...
    "Enforce secure view on tagged files" : "Appliquer l'affichage sécurisé aux fichiers marqués",
    "Select tags to enforce watermarking" : "Sélectionner des étiquettes pour appliquer le filigrane",
    "Enforce secure view for users of groups" : "Appliquer l'affichage sécurisé aux utilisateurs des groupes",
    "Enforce secure view for all shares" : "Appliquer l'affichage sécurisé aux partages",
    "Enforce secure view for read only shares" : "Appliquer l'affichage sécurisé aux partages en lecture seule",
    "Enforce secure view for all public Talk shares" : "Appliquer l'affichage sécurisé aux partages publics Talk",
    "Enforce secure view for shares without download permission" : "Appliquer l'affichage sécurisé aux partages sans droit de téléchargement",
    "Enforce secure view for all link shares" : "Appliquer l'affichage sécurisé à tous les liens de partage",
    "Enforce secure view for download hidden shares" : "Appliquer l'affichage sécurisé aux téléchargements de partages masqués",
    "Enforce secure view for read only link shares" : "Appliquer l'affichage sécurisé aux liens de partage en lecture seule",
    "Enforce secure view on link shares with specific system tags" : "Appliquer l'affichage sécurisé aux liens de partage avec des étiquettes spécifiques",
    "Select tags to enforce secure view" : "Sélectionnez les étiquettes pour appliquer l'affichage sécurisé",
    "Electronic Signature" : "Signature électronique",
    "Client ID for the electronic signature API" : "Identifiant Client pour l'API de signature électronique",
    ...
    "File name already exists" : "Le nom de fichier existe déjà",
    ...
    "Please check the Collabora Online server log for more details and make sure that Nextcloud can be reached from there." : "Veuillez vérifier les logs du serveur Collabora Online pour plus de détails et assuez-vous que Nextcloud peut l'atteindre.",
    ...
    "Error: Exec disabled in PHP, please enable it, or setup a standalone server." : "Erreur : L’exécution est désactivée dans PHP, veuillez l'activer, ou configurer un serveur autonome.",
    ...
    "Insert into document" : "Insérer dans le document",
    ...
    "Collabora Online is not setup yet. Please contact your administrator." : "Collabora Online n'est pas encore configuré. Veuillez contacter votre administrateur.",
    "Opening the file is not supported, since the credentials for the external storage are not available without a session" : "L'ouverture du fichier n'est pas prise en charge, car les informations d'identification pour le stockage externe ne sont pas disponibles sans session.",
