OC.L10N.register(
    ...
    "New spreadsheet" : "Nouvelle feuille LO Calc",
    "New presentation" : "Nouvelle présentation LO Impress",
    "New diagram" : "Nouveau diagramme LO Draw",
    "Nextcloud Office" : "Nextcloud Office",
    "Cannot create document" : "Impossible de créer un document",
    ...
    "Nextcloud Office is a powerful Collabora Online based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "Nextcloud Office est une suite bureautique en ligne basée sur Collabora Online avec édition collaborative qui prend en charge tous les principaux documents, feuilles de calcul et formats de fichiers de présentation et fonctionne avec tous les navigateurs modernes.",
    ...
    "If the installation from the App Store fails, you can still do that manually using this command:" : "Si l'installation depuis le magasin d'application échoue, vous pouvez toujours le faire manuellement en utilisant cette commande :",
    ...
    "it uses an insecure protocol (HTTP)" : "utilise un protocole non sécurisé (HTTP)",
    ...
    "{productName} is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "{productName} est par défaut activé pour tous les utilisateurs. Lorsque ce paramètre est actif, seuls les membres des groupes spécifiés peuvent l'utiliser.",
    "Select groups" : "Sélectionnez les groupes",
    "Restrict edit to specific groups" : "Limiter l'édition à certains groupes",
    "All users can edit documents with {productName} by default. When this setting is active, only the members of the specified groups can edit, whereas the others can only view documents." : "Par défaut tous les utilisateurs peuvent modifier des documents avec {productName} . Lorsque ce paramètre est actif, seuls les membres des groupes spécifiés peuvent modifier, tandis que les autres peuvent uniquement afficher les documents. ",
    ...
    "Error: Not running on x86-64 or ARM64 (aarch64) Linux, please setup a standalone server." : "Erreur : Ne fonctionne pas sous x86-64 ou ARM64 (aarch64) Linux, veuillez créer un serveur autonome.",
