    ...
    <div id="casSettings" class="personalblock">
        ...
        <fieldset id="casSettings-8">
            ...
            <div style="margin-left: 20px;">
                ...
                <p>On accedera à chaque élément en suivant son ordre, avec ${1}, ${2}, ... dans cet exemple ${1} = esco, ${2} = Etablissements, ${3} = DE L IROISE_0290009C, ${4} = TERMINALE GENERALE et TECHNO YC BT et ${5} = Eleves_TS1</p>
                <p>Pour finir si dans le champ 'Nommage' on a '${3}.${5}' alors le résultat sera : 'DE L IROISE_0290009C.Eleves_TS1'</p>
            </div>
            <br>
            <div style="display: flex;">
                ...
                <p>
                    <label for="cas_import_map_groups_filter"><?php p($l->t('Regex de filtre')); ?></label>
                    <input
                            style="width: 65%"
                            id="cas_import_map_groups_filter"
                            name="cas_import_map_groups_filter"
                            value="<?php p($_['cas_import_map_groups_filter']); ?>" placeholder="Regex de filtre"/>
                </p>
                <p>
            ...
            <div style="margin-left: 20px;">
                ...
                <p>Pour récupérer les attributs en fin de groupe (après le '$') du groupe 'ENTStructureSIREN=00000000000001,ou=structures,dc=esco-centre,dc=fr$1DNLMAGR1$060F00', dans cet exemple '1DNLMAGR1' '060F00', on accedera avec ${1}, ${2}, ... dans cet exemple ${1} = 1DNLMAGR1 et ${2} = 060F00 </p>
                <p>Pour finir si dans le champ 'Nommage' on a '${ENTStructureNomCourant}_${ENTStructureUAI}.Profs_${1}' alors le résultat sera : 'NomDeLaStructure_0370038R.Profs_1DNLMAGR1'</p>
            </div>
            <br>
            <div>
                <div>
