...
\begin{frame}[fragile]{Plugin File sharing}{Présentation}
...
\begin{frame}[fragile]{Plugin File sharing}{Utilisation}
\vspace{-20pt}
\begin{figure}
\includegraphics[width=\textwidth]{Fonctionnement-fork-files_sharing.pdf}
\end{figure}
\end{frame}
\begin{frame}[fragile]{Plugin File sharing}{Backend}
\begin{itemize}
	\item 2 routes :
		\begin{list}{-}{}
...
\begin{frame}[fragile]{Plugin File sharing}{Frontend}
